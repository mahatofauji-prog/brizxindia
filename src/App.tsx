...
import BrandSmartMatchPage from './pages/brand/BrandSmartMatchPage';
...
import DirectoryAuthGate from './components/DirectoryAuthGate';
      ...
      <Routes>
        ...
        <Route path="/" element={<PublicLayout />}>
          ...
          <Route path="brands" element={
            <DirectoryAuthGate action="browse_brands" redirectUrl="/brands">
              <BrandListing />
            </DirectoryAuthGate>
          } />
          <Route path="brands/:id" element={
            <DirectoryAuthGate action="browse_brands">
              <BrandDetails />
            </DirectoryAuthGate>
          } />
          <Route path="seekers" element={
            <DirectoryAuthGate action="browse_seekers" redirectUrl="/seekers">
              <SeekerListing />
            </DirectoryAuthGate>
          } />
          <Route path="seekers/:id" element={
            <DirectoryAuthGate action="browse_seekers">
              <SeekerDetails />
            </DirectoryAuthGate>
          } />
          <Route path="smart-match" element={
            <DirectoryAuthGate action="smart_matching" redirectUrl="/smart-match">
              <BrandListing initialOpenSmartMatch={true} />
            </DirectoryAuthGate>
          } />
        ...
        <Route element={<DashboardLayout />}>
          ...
          <Route path="/brand/smart-match" element={
            <ProtectedRoute allowedRoles={['BRAND_OWNER', 'SUPER_ADMIN']}>
              <BrandSmartMatchPage />
            </ProtectedRoute>
          } />
