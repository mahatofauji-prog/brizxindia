    ...
    <div className="w-full bg-[#FAFCFF] min-h-screen text-slate-900 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Brand -> Seeker Smart Match Banner Card */}
          <div className="bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-900 rounded-3xl p-6 sm:p-7 text-white shadow-lg relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div className="space-y-2">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/20 text-blue-300 border border-blue-400/30 rounded-full text-[11px] font-black uppercase tracking-wider">
                  <Sparkles size={13} className="text-blue-400 animate-pulse" />
                  Brand → Seeker Match Engine
                </div>
                <h3 className="text-2xl font-black font-heading text-white">
                  Find the Right Franchise Seekers for Your Brand
                </h3>
                <p className="text-xs sm:text-sm text-slate-300 max-w-xl leading-relaxed">
                  Enter your expansion criteria (City, PIN, Budget, Industry, Experience, and Timeline). Our 100-point algorithm will calculate and rank verified candidate matches.
                </p>
              </div>

              <Link
                to="/brand/smart-match"
                className="px-6 py-3.5 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl text-xs sm:text-sm font-black uppercase tracking-wider transition-all shadow-md shadow-blue-500/20 flex items-center gap-2 shrink-0 active:scale-95"
              >
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/brand/smart-match" className="text-xs font-bold text-blue-700 hover:text-blue-600 flex items-center gap-1 transition-colors">
              Launch Smart Match <ArrowRight size={14} />
            </Link>
          </div>
